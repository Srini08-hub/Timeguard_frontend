...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-gray-200 bg-white/95 px-4 shadow-sm shadow-gray-950/5 backdrop-blur supports-[backdrop-filter]:bg-white/80 dark:border-gray-800 dark:bg-gray-950/90 dark:shadow-black/20 sm:px-6">
      <div className="flex min-w-0 items-center gap-3">
        <Button
          ...
          className="h-10 w-10 shrink-0 text-gray-500 hover:text-gray-950 dark:text-gray-400 dark:hover:text-white"
        >
