...
import { useNonTimesheetEmails } from '../hooks/useNonTimesheetEmails';
...
export const NonTimeSheet: React.FC = () => {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 dark:border-gray-800 pb-5">
                <div>
                    ...
                    <p className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">
                        View emails classified as non-timesheets and access their source documents. Refreshes automatically.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 space-y-4">
                    <h2 className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">
                        Non-Timesheet Emails ({emails.length})
                    </h2>
                    ...
                    {isEmailsLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center p-12 text-center bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-2xs">
                            ...
                            <h3 className="mt-4 text-sm font-semibold text-gray-900 dark:text-white">No non-timesheet emails found</h3>
                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">No emails have been classified as non-timesheets yet.</p>
                        </div>
                    ) : (
                    ...
                    {selectedEmail ? (
                        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-2xs p-6 space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="p-4 rounded-xl bg-gray-50/50 dark:bg-gray-800/10 border border-gray-100 dark:border-gray-850 space-y-3">
                                    ...
                                    <div>
                                        ...
                                        {selectedEmail.body ? (
                                            <div className="text-sm text-gray-750 dark:text-gray-300 bg-white dark:bg-gray-900 p-3.5 rounded-lg border border-gray-100 dark:border-gray-800 whitespace-pre-wrap break-words max-h-60 overflow-y-auto font-sans leading-relaxed">
                                                {selectedEmail.body}
                                            </div>
                                        ) : (
                            ...
                            <div className="space-y-4">
                                <h4 className="text-sm font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                                    ...
                                    Associated Non-Timesheet Documents
                                </h4>
                        ...
                        <div className="h-full flex flex-col items-center justify-center p-12 text-center bg-gray-50/50 dark:bg-gray-900/20 border border-dashed border-gray-250 dark:border-gray-800 rounded-2xl min-h-[300px]">
                            ...
                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 max-w-[280px] mx-auto">
                                Select a Non-Timesheet email from the list on the left to inspect its status and retrieve non-timesheet documents.
                            </p>
                        </div>
                    )}
                </div>
